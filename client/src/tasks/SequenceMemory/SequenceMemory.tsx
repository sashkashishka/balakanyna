    ...
    >
      <Show when={gameState() === 'start'}>
        <div class={styles.screen}>
          <h2>Послідовна пам'ять</h2>
          <p>
            Запам'ятайте послідовність кнопок, що світяться, а потім натискайте їх по
            порядку.
          </p>
          <p>Кожного разу, коли ви завершуєте шаблон, він стає довшим.</p>
          <p>Зробіть помилку, і тест закінчиться.</p>
